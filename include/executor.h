...
namespace detail
{
    ...
    public:
        ...
        virtual void add(std::function<void(void)> f) override
        {
            return _executor.add(std::move(f));
        }
...
public:
    ...
    {
        return implementation()->add(std::move(f));
    }
...
public:
    ...
    void add(std::function<void(void)> f)
    {
        _implementation->add(std::move(f));
    }
